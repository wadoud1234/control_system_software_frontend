...
export default function ImpulseResponse({ t_max }: { t_max: number }) {
  ...
  async function handlePlot() {
    try {
      let response;
      if (type === "tf")
        response = await transfer_function_api.impulse({
          ...state,
          t_max,
          x_axis,
          y_axis,
        ...
        response = await state_space_api.impulse({
          ...state,
          t_max,
          x_axis,
          y_axis,
