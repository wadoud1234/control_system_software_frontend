...
export default function RampResponse({ t_max }: { t_max: number }) {
  ...
  async function handlePlot() {
    try {
      let response;
      if (type === "tf")
        response = await transfer_function_api.ramp({
          ...state,
          t_max,
          x_axis,
          y_axis,
        ...
        response = await state_space_api.ramp({
          ...state,
          t_max,
          x_axis,
          y_axis,
